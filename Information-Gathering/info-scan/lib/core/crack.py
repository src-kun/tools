...
class Hydra():
	...
	def start(self, target = None, targets_path = None, user = None, user_dict_path = None, password = None, password_dict_path = None, userpass_dict_path = None, format = 'json', report_path = None):
